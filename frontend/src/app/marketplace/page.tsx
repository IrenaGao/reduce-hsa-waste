...
const MOCK_SERVICES: Service[] = [
  {
    ...
    location: 'Tribeca',
    address: '125 Hudson St, New York, NY 10013',
  ...
  },
  {
    ...
    category: 'Wellness',
    description: 'Personalized treatment to address areas of restriction and optimization of mobility. Includes Myoskeletal Alignment, Graston Technique, Functional Mobility, Deep Tissue, TMJ Release, and Prenatal/Postpartum Massage.',
    price: 225,
    duration: '60 minutes',
    ...
    coordinates: { lat: 40.7317, lng: -73.9546 }
  },
  {
    id: '3',
    ...
    location: 'SoHo',
    address: '470 Broadway, New York, NY 10013',
    coordinates: { lat: 40.7234, lng: -74.0026 }
  },
  {
    id: '4',
    ...
    coordinates: { lat: 40.7295, lng: -74.0020 }
  },
  {
    id: '5',
    ...
    address: '1285 Madison Ave, New York, NY 10128',
  ...
  },
  {
    ...
    category: 'Alternative Medicine',
    description: 'Traditional Chinese medicine acupuncture session for pain relief and wellness.',
    price: 110,
    duration: '60 minutes',
    provider: 'East West Acupuncture',
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=400&h=300&fit=crop&crop=center',
    hsaEligible: true,
    conditions: ['Chronic Pain', 'Anxiety', 'Migraines', 'Digestive Issues'],
    location: 'Chinatown',
    address: '125 Canal St, New York, NY 10002',
    coordinates: { lat: 40.7151, lng: -74.0016 }
  },
  {
    id: '8',
    name: 'Fitness Training Session',
    category: 'Fitness',
    description: 'Personal training session focused on strength, conditioning, and injury prevention.',
    price: 100,
    duration: '60 minutes',
    provider: 'NYC Fitness Pro',
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=300&fit=crop&crop=center',
    hsaEligible: false,
    conditions: ['General Fitness', 'Weight Loss', 'Muscle Building'],
    location: 'Chelsea',
    address: '200 8th Ave, New York, NY 10011',
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {service.conditions.slice(0, 3).map((condition) => (
                              <span key={condition} className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                {condition}
                              </span>
                            ))}
                          </div>
        ...
        <div className="w-2/5 border-l border-gray-200">
          <div className="h-full relative">
            ...
            <div className="absolute top-4 left-4 right-4 z-10">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  <span className="text-xs text-gray-600">Showing {filteredServices.length} services in NYC</span>
                  {selectedServiceId && (
                    <span className="text-xs text-blue-600 font-medium">
                      • Service selected on map
                    </span>
                  )}
                </div>
              </div>
            ...
            <div className="absolute bottom-4 left-4 bg-white rounded-lg shadow-sm border border-gray-200 p-3 z-10">
              <div className="text-xs font-medium text-gray-900 mb-2">Service Types</div>
              <div className="space-y-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-600">Alternative Medicine</span>
                </div>
                <div className="flex items-center space-x-2">
